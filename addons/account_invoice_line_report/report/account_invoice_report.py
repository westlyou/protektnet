...
class AccountInvoiceReport(models.Model):
    ...
    product_brand = fields.Selection(store=True, related="product_id.product_brand")
    ...
    _depends = {
        ...
        'product.template': ['categ_id', 'product_brand'],
    ...
    def _select(self):
        select_str = """
            SELECT sub.id, sub.date, sub.product_id, sub.product_brand, sub.partner_id, sub.country_id, sub.account_analytic_id,
    ...
    def _group_by(self):
        group_by_str = """
                GROUP BY ail.id, ail.product_id, ail.account_analytic_id, ai.date_invoice, ai.id,
                    ai.partner_id, ai.payment_term_id, u2.name, u2.id, ai.currency_id, ai.journal_id, pt.product_brand,
