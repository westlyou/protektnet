odoo.define('odoo_magento_connect.tour', function(require) {
"use strict";
...
tour.register('magento_bridge_tour', {
    ...
    trigger: '.o_app[data-menu-xmlid="odoo_magento_connect.magento_parent_menu"], .oe_menu_toggler[data-menu-xmlid="odoo_magento_connect.magento_parent_menu"]',
    content: _t('Start connecting your odoo with magento using <b>Magento odoo Bridge app</b>.'),
    position: 'bottom',
}, {
    trigger: ".o_mob_dashboard .o_dashboard_action[name=\"odoo_magento_connect.magento_configure_tree_action\"]:last",
...
, {
    trigger: ".o_mob_dashboard .o_dashboard_action[name=\"odoo_magento_connect.magento_synchronization_action\"]",
    extra_trigger: '.o_mob_dashboard',
